...
class FacturasController extends Controller
{
    ...
    {
        $data['solicitudes'] = Factura::with('cliente')->orderBy('id', 'asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $twilio->messages->create($to, [
                "from" => $from,
                "body" => "Hola {$c->nombre}, recibimos tu solicitud de medicamento #{$f->id}. Estatus actual: {$f->estatus}. Hemos enviado la planilla al correo. Consulta detalles en: https://t.me/sicmec_ayuda_bot"
            ]);
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($f->estatus == "Aprobada") {
                $statusMsg = "¡Buenas noticias {$c->nombre}! Tu solicitud #{$f->id} ha sido APROBADA. Puedes retirar tu medicamento en la oficina de Atención al Ciudadano.";
            } elseif ($f->estatus == "Finalizado") {
                $statusMsg = "Hola {$c->nombre}, tu solicitud #{$f->id} ha sido FINALIZADA. Gracias por confiar en nosotros.";
            }
